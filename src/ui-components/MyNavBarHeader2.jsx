...
export default function MyNavBarHeader2(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "MyNavBarHeader2")}
      {...rest}
    >
      <Flex
        gap="32px"
      ...
      >
        <Button
          ...
          variation="link"
          children="Log in"
          {...getOverrideProps(overrides, "Button38474733")}
        ></Button>
        <Button
          width="unset"
          height="unset"
          ...
          variation="primary"
          children="Sign up"
          {...getOverrideProps(overrides, "Button38474734")}
        ></Button>
      </Flex>
    </Flex>
  );
