...
export default function MyReviewCardExample(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "MyReviewCardExample")}
      {...rest}
    >
      <Image
        width="400px"
      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(
              overrides,
              "Information about this product.38921233"
            )}
          ></Text>
          <Text
            fontFamily="Inter"
            ...
            {...getOverrideProps(
              overrides,
              "Information about this product.38921234"
            )}
          ></Text>
        </Flex>
        <Badge
